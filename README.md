# PSONO Admin Client - Password Manager [WIP: No release yet]
...
in all web browsers. Service worker registration [won't be attempted](src/services/worker.js)
...
starting point, you can make use of the logic included in [`src/worker.js`](src/services/worker.js), which
