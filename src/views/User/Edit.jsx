					...
					<RegularCard
								...
								<Grid container>
									<GridItem xs={12} sm={12} md={6}>
										<CustomInput
											...
											inputProps={{
												value: moment(user.create_date).format(
													"YYYY-MM-DD HH:mm:ss",
												),
												disabled: true,
												readOnly: true,
						...
						footer={
							<>
								...
								<Button onClick={() => setDeleteUserModalOpen(true)}>
									{t("DELETE")}
								</Button>
								{store.getState().server.type == "EE" &&
									user.authentication !== "AUTHKEY" && (
										<Button onClick={() => setWipeUserModalOpen(true)}>
											{t("WIPE")}
										</Button>
									)}
							</>
			...
			<Grid container>
				<GridItem xs={12} sm={12} md={12}>
					<UserCard
						...
						onDeleteGoogleAuthenticators={onDeleteGoogleAuthenticators}
