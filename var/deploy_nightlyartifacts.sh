...
gcloud storage cp webclient.zip gs://get.psono.com/psono/psono-admin-client/nightly/adminclient.zip && \
gcloud storage cp sbom.json gs://get.psono.com/psono/psono-admin-client/nightly/sbom.json
